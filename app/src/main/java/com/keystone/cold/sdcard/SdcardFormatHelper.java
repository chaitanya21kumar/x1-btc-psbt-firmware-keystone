...
import com.x1-btc-psbt-firmware.cold.databinding.FormatSdcardHintModalBinding;
import com.x1-btc-psbt-firmware.cold.databinding.FormatSdcardProgressModalBinding;
...
public class SdcardFormatHelper {
    ...
    public void showFormatModal(AppCompatActivity activity) {
        ...
        binding.close.setOnClickListener(v -> formatDialog.dismiss());
        DiskInfo finalTargetDisk = targetDisk;
        binding.confirm.setOnClickListener(v -> {
            formatDialog.dismiss();
            showFormatProgress(activity, storageManager, finalTargetDisk);
        });
        formatDialog.show(activity.getSupportFragmentManager(), "");
    }
