...
import static com.x1-btc-psbt-firmware.cold.callables.UpdateCallable.TYPE_PACKAGE_HEADER;
import static com.x1-btc-psbt-firmware.cold.callables.UpdateCallable.calculatePackageType;
import static com.x1-btc-psbt-firmware.cold.callables.UpdateCallable.fitBuffer;
...
public class RequestUpdateCallable implements Callable<Boolean> {
    ...
    private final String TAG = "RequestUpdateCallableNew";
