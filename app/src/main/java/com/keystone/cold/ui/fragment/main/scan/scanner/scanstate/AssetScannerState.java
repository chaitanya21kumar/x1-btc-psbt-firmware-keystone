...
import static com.x1-btc-psbt-firmware.cold.ui.fragment.setup.WebAuthResultFragment.WEB_AUTH_DATA;
...
import com.x1-btc-psbt-firmware.cold.viewmodel.X1-BTC-PSBT-FirmwareTxViewModel;
...
public class AssetScannerState extends ScannerState {
    ...
    public void handleScanResult(ScanResult result) throws Exception {
        if (result.getType().equals(ScanResultTypes.PLAIN_TEXT)) {
            ...
            if (handleX1-BTC-PSBT-FirmwareTx(result)) return;
    ...
    private boolean handleX1-BTC-PSBT-FirmwareTx(ScanResult result) throws InvalidTransactionException,
            XfpNotMatchException, JSONException, UnknowQrCodeException, CoinNotFindException,
            WatchWalletNotMatchException {
        X1-BTC-PSBT-FirmwareTxViewModel viewModel = ViewModelProviders.of(mActivity).get(X1-BTC-PSBT-FirmwareTxViewModel.class);
