...
import com.x1-btc-psbt-firmware.cold.databinding.MultisigCasaPerformHealthCheckBinding;
...
public class CasaPerformHealthCheckFragment extends BaseFragment<MultisigCasaPerformHealthCheckBinding> implements Callback {
    ...
    private static final Pattern messagePattern = Pattern.compile("^[0-9a-fA-F]+-[0-9a-fA-F]+-[0-9a-fA-F]+-[0-9a-fA-F]+-[0-9a-fA-F]+$");
