...
import static com.x1-btc-psbt-firmware.cold.selfcheck.SecurityCheck.CODE_FW_GET_STATUS_FAILED;
import static com.x1-btc-psbt-firmware.cold.selfcheck.SecurityCheck.CODE_FW_IN_BOOTMODE;
import static com.x1-btc-psbt-firmware.cold.selfcheck.SecurityCheck.CODE_STATUS_MIS_MATCH;
import static com.x1-btc-psbt-firmware.cold.selfcheck.SecurityCheck.CODE_STATUS_RUNTIME_INVALID;
import static com.x1-btc-psbt-firmware.cold.ui.fragment.setting.MainPreferenceFragment.removeAllFingerprint;
import static com.x1-btc-psbt-firmware.cold.ui.fragment.setting.MainPreferenceFragment.reset;
...
import com.x1-btc-psbt-firmware.cold.databinding.AttackWarningBinding;
...
public class AttackWarningFragment extends BaseFragment<AttackWarningBinding> {
    ...
    protected void init(View view) {
        ...
        if (firmware == CODE_FW_IN_BOOTMODE) {
            ...
            mBinding.hint.setText(getString(R.string.contact_x1-btc-psbt-firmware_service, formatErrorCode(data)));
