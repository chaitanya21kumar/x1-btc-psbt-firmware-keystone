...
import com.x1-btc-psbt-firmware.cold.databinding.CaravanCreateWalletSuccessfulBinding;
import com.x1-btc-psbt-firmware.cold.databinding.CollectExpubBinding;
import com.x1-btc-psbt-firmware.cold.databinding.CommonModalBinding;
import com.x1-btc-psbt-firmware.cold.databinding.XpubFileItemBinding;
import com.x1-btc-psbt-firmware.cold.databinding.XpubInputBinding;
import com.x1-btc-psbt-firmware.cold.databinding.XpubListBinding;
...
import com.x1-btc-psbt-firmware.cold.ui.fragment.main.scan.scanner.exceptions.UnExpectedQRException;
import com.x1-btc-psbt-firmware.cold.ui.modal.ModalDialog;
import com.x1-btc-psbt-firmware.cold.update.utils.FileUtils;
import com.x1-btc-psbt-firmware.cold.viewmodel.CollectXpubViewModel;
import com.x1-btc-psbt-firmware.cold.viewmodel.SharedDataViewModel;
import com.x1-btc-psbt-firmware.cold.viewmodel.exceptions.CollectExPubWrongDataException;
import com.x1-btc-psbt-firmware.cold.viewmodel.exceptions.CollectExPubWrongTypeException;
...
public class CollectExpubFragment extends MultiSigBaseFragment<CollectExpubBinding>
    ...
    private void createWallet() {
        try {
            ...
            multiSigViewModel.createMultisigWallet(threshold, account, null, array, "X1-BTC-PSBT-Firmware")
    ...
    private void extractArguments() {
        ...
        account = com.x1-btc-psbt-firmware.coinlib.accounts.MultiSig.ofPath(path, Utilities.isMainNet(mActivity)).get(0);
    }
