...
package com.x1-btc-psbt-firmware.cold.encryptioncore.serial;
...
public class SerialManagerProxyImpl implements SerialManagerProxy {
    ...
    private SerialManagerProxyImpl(@NonNull SerialManager proxy, Context context, int portSpeed) {
        ...
        wakeLock = Objects.requireNonNull(pm).newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "X1-BTC-PSBT-Firmware:encryption");
        mProxy = proxy;
