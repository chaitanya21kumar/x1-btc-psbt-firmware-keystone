...
import static com.x1-btc-psbt-firmware.coinlib.RSA.decrypt;
import static com.x1-btc-psbt-firmware.coinlib.Util.decodeRSFromDER;
...
public class UtilTest {
    ...
    @Test
    public void testa() {
        byte[] bytes = Base58.decodeChecked("xpub6ERApfZwUNrhLCkDtcHTcxd75RbzS1ed54G1LkBUHQVHQKqhMkhgbmJbZRkrgZw4koxb5JaHWkY4ALHY2grBGRjaDMzQLcgJvLJuZZvRcEL");

        System.out.println(bytes.length);
        System.out.println(Hex.toHexString(Arrays.copyOfRange(bytes,5, 9)));
        System.out.println(Hex.toHexString(Arrays.copyOfRange(bytes,45, 78)));
//        0488b21e 4
//    04
//    78412e3a
//                fffffffe
//        637807030d55d01f9a0cb3a7839515d796bd07706386a6eddf06cc29a65a0e29 32
//    02d2b36900396c9282fa14628566582f206a5dd0bcc8d5e892611806cafb0301f0 33
        //7e652001
